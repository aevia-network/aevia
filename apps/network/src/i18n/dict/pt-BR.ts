export const ptBR = {
  ...
  landing: {
    hero: {
      ...
      subtitle:
        'vídeo soberano para criadores silenciados. o protocolo aevia ancora manifestos em base l2 e paga nós de persistência em cUSDC para manter cópias disponíveis quando cdns comerciais falham.',
    },
    portals: [
      {
        index: '01',
